/**
  ...
  * in any form.
  *
  * Source : $File: //depot/4669_TIP/TA_BASE/transactive/bus/scada/DataPointAgentCorbaDef_Impl/src/DataPointAgentCorbaDef_Impl.cpp $
  * @author  HoaVu
  * @version $Revision: #2 $
  * Last modification : $DateTime: 2011/07/20 11:18:12 $
...
namespace TA_Base_Bus
{
	...
	{
		m_operationMode = TA_Base_Core::Monitor; // merger from 3002; for terminal agent crash.
