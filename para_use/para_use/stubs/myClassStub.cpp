...
/** User stub definition for function: void myClass::addBigOne(int, int) */
void (::myClass::CppTest_Stub_addBigOne) (int a, int b) 
{
...
/** User stub definition for function: int printf(const char *, ...) */
extern "C" int __cdecl printf (const char * _Format, ...) ;
extern "C" int __cdecl CppTest_Stub_printf (const char * _Format, ...) 
{
