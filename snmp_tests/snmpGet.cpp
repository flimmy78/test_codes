...
/*
  ...
  Peter E. Mellquist
*/
char snmpget_cpp_version[]="@(#) SNMP++ $Id: snmpGet.cpp,v 1.1.4.1 2005/03/23 04:00:41 greggk Exp $";
...
int main_get_jun( int argc, char **argv)
{
   ...
   pdu += vb;
   Oid oid2("1.3.6.1.2.1.1.6.0");
   vb.set_oid(oid2);
   pdu += vb;
   Oid oid3("1.3.6.1.2.1.1.6.0");
   vb.set_oid(oid3);
   pdu += vb;
   Oid oid4("1.3.6.1.2.1.1.5.0");
   vb.set_oid(oid4);
   pdu += vb;

   Oid oid5("1.3.6.1.2.1.25.2.3.1.5.1");
	vb.set_oid(oid5);
   pdu += vb;
