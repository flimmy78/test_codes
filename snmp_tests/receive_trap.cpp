...
char receivetrap_cpp_version[]="@(#) SNMP++ $Id: receive_trap.cpp,v 1.1.4.1 2005/03/23 04:00:41 greggk Exp $";
...
int main_r_trap_jun(int argc, char **argv)
{
  ...
  usm->add_usm_user("SHAIDEA",
   ...
   while (1)
     snmp.eventListHolder->SNMPProcessEvents(500);
