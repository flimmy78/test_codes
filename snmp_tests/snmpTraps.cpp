...
/*
  ...
  Peter E. Mellquist
*/
char snmptraps_cpp_version[]="@(#) SNMP++ $Id: snmpTraps.cpp,v 1.1.4.1 2005/03/23 04:00:41 greggk Exp $";
...
#define PAYLOAD "SNMP++ Trap Send Testxxx"
...
int main_trap_jun(int argc, char **argv)
{
   ...
   printf("%s vs %s\n", address.get_printable(), ip.get_printable());
